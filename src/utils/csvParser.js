 ...
 * @param {string} year - Year filter (e.g., '2020', 'all')
...
/**
 * Aggregate vehicle data by state (not by city)
 * @param {Array} vehicles - Vehicle records
 * @returns {Array} Aggregated data with state-level coordinates
 */
...
/**
 * Aggregate vehicle data by location (DEPRECATED - use aggregateByState instead)
 * @param {Array} vehicles - Vehicle records
